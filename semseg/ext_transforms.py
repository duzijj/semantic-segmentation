...
def voc_train_transform(crop_size):
    train = ExtCompose([
    # et.ExtResize(size=opts.crop_size),
    ExtRandomScale((0.5, 2.0)),
    ExtRandomCrop(size=(crop_size, crop_size), pad_if_needed=True),
...
def transform(size):
    ...
    train_transform = ExtCompose([
        # et.ExtResize( 512 ),
        ExtRandomScale((0.5, 2.0)),
        ExtRandomCrop(size=(size[0], size[1]), pad_if_needed=True),
